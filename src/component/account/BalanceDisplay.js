...
import { getBalance, getTransactionHistory } from '../../api/accountApi';
                    ...
                    const updatedBalance =
                        latestTransaction.des_wit_type === '1'
                            ? latestTransaction.pre_balance -
                              latestTransaction.transfer_balance // 출금이면 빼기
                            : latestTransaction.pre_balance +
                              latestTransaction.transfer_balance; // 입금이면 더하기
